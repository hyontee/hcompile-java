...
void CWeather::InjectHooks() {
    ...
    CHook::Write(g_libGTASA + (VER_x32 ? 0x6789EC : 0x84F400), &TrafficLightsBrightness);
    CHook::Write(g_libGTASA + (VER_x32 ? 0x67609C : 0x84A1C0), &SunGlare);
    CHook::Write(g_libGTASA + (VER_x32 ? 0x679F4C : 0x851EA8), &Rain);
