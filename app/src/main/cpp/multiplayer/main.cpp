...
extern "C" {
JNIEXPORT void JNICALL Java_com_brilliant_game_core_Samp_initializeSAMP(JNIEnv *pEnv, jobject thiz)
{
    pJavaWrapper = new CJavaWrapper(pEnv, thiz);

}
JNIEXPORT void JNICALL Java_com_brilliant_game_core_Samp_onInputEnd(JNIEnv *pEnv, jobject thiz, jbyteArray str)
{
    if(pUI)
    {
...
JNIEXPORT void JNICALL Java_com_brilliant_game_core_Samp_onEventBackPressed(JNIEnv *pEnv, jobject thiz)
{
    if(pSettings)
    {
...
JNIEXPORT void JNICALL Java_com_brilliant_game_core_Samp_onTabClosed(JNIEnv *pEnv, jobject thiz)
{
    HideJavaTabList();
}
JNIEXPORT void JNICALL Java_com_brilliant_game_ui_dialog_DialogManager_sendDialogResponse(JNIEnv* pEnv, jobject thiz, jint i3, jint i, jint i2, jbyteArray str)
{
...
extern "C"
JNIEXPORT void JNICALL Java_com_brilliant_game_core_Samp_onChatInputRequested(JNIEnv *pEnv, jobject thiz)
{
...
extern "C"
JNIEXPORT void JNICALL Java_com_brilliant_game_core_Samp_onWeaponChanged(JNIEnv *pEnv, jobject thiz)
{
    RequestWeaponCycle();
}
extern "C"
JNIEXPORT void JNICALL Java_com_brilliant_game_core_Samp_onKeyboardHidden(JNIEnv *pEnv, jobject thiz)
{
    if (pUI && pUI->keyboard()) {
...
Java_com_brilliant_game_ui_hud_Hud_clickCameraMode(JNIEnv *env, jobject thiz) {
    if(!pNetGame)return;
