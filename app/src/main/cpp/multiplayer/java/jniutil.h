...
public:
	...
	void ShowTab();
	void ShowSpawn(int home, int fraction);
	void ShowAZS(int fuelId, int maxFuel, float currentFuel, int price, int balance);
	void ShowGPS(int value);
	void ShowGreenZone(int value);
	void ShowNumbers(int balance);
	void BuyNumberResult(int status, int reason);
	void HideTab();
