...
Java_com_brilliant_game_ui_hud_Speedometr_nativeInit(JNIEnv *env, jobject thiz) {
...
void CSpeedometr::update() {
    ...
    jmethodID method = env->GetMethodID(clazz, "update", "(IIIIII)V");
    env->CallVoidMethod(
            CSpeedometr::thiz,
            method,
...
extern "C"
JNIEXPORT void JNICALL
Java_com_brilliant_game_ui_hud_Speedometr_nativeSendClick(JNIEnv *env, jobject thiz,
                                                                  jint id) {
