...
Java_com_brilliant_game_ui_attach_AttachEdit_Exit(JNIEnv *env, jobject thiz) {
...
extern "C"
JNIEXPORT void JNICALL
Java_com_brilliant_game_ui_attach_AttachEdit_AttachClick(JNIEnv *env, jobject thiz, jint button_type,
                                                  jboolean button_id) {
...
extern "C"
JNIEXPORT void JNICALL
Java_com_brilliant_game_ui_attach_AttachEdit_Save(JNIEnv *env, jobject thiz) {
    CPlayerPed* pPlayer = pNetGame->GetPlayerPool()->GetLocalPlayer()->GetPlayerPed();
    int slot = CObjectEditor::iEditedId;
    auto attach = pPlayer->GetAttachedObject(slot);
