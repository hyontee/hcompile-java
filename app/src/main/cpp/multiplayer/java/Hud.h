...
public:
    ...
    static const int BUTTON_ALT = 5;
    static const int BUTTON_H = 6;
    static const int BUTTON_N = 7;
    static const int BUTTON_Y = 8;
    ...
    static void toggleSeatButton(bool toggle);
