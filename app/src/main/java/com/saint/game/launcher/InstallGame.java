...
import com.saint.game.BuildConfig;
...
import static com.saint.game.core.Config.APP_PATH;
import static com.saint.game.core.Config.GAME_PATH;
import static com.saint.game.core.Config.PATH_DOWNLOADS;
import static com.saint.game.core.Config.URL_CLIENT;
import static com.saint.game.core.Config.URL_FILES;
import static com.saint.game.core.Config.URL_FILES_UPDATE;
...
public class InstallGame extends AppCompatActivity {
    ...
    private class DownloadTask extends AsyncTask<String, Integer, String> {
        ...
        protected void onProgressUpdate(Integer... progress)
        {
            ...
            if(Utils.getType() == 0) loading.setText("Идет загрузка кеша (byDmitry_Komarov)...                  "+progress[0] + "%");
            if(Utils.getType() == 1) loading.setText("Идет загрузка лаунчера (byDmitry_Komarov)...               "+progress[0] + "%");
            if(Utils.getType() == 2) loading.setText("Идет загрузка доп.файлов (byDmitry_Komarov)...            "+progress[0] + "%");
