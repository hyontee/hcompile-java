...
public class LoadGameActivity extends BaseActivity {
    ...
    private static final String CACHE_URL = "https://www.dropbox.com/scl/fi/2a49phf993p9izrjhcm91/cache.zip?rlkey=tq84ffg9md2ey24xl2v5a0r05&st=7nhwriph&dl=1";
    private static final String CACHE_ZIP_PATH = Environment.getExternalStorageDirectory() + "/Android/data/com.brilliant.game/cache.zip";
    private static final String EXTRACT_DIR = Environment.getExternalStorageDirectory() + "/Android/data/com.brilliant.game/";
