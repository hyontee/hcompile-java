...
import ru.edgar.matrp.GameRender;
import ru.edgar.matrp.InterfacesManager;
import ru.edgar.matrp.R;
import ru.edgar.matrp.core.DialogClientSettings;
import ru.edgar.matrp.gui.Notification;
import ru.edgar.matrp.gui.dialogs.Dialog;
...
public abstract class NvEventQueueActivity
    ...
    protected boolean systemInit()
    {
        ...
        //mInterfacesManager = new ru.edgar.matrp.gui.keyboard.j5.a(this);
    ...
    public void setPauseState(final boolean z6) {
        ...
        runOnUiThread(new Runnable() {
            @Override
            public void run() {
                NvEventQueueActivity.this.mHeadUILayout.setVisibility(z6 ? View.GONE : View.VISIBLE);
            }
        });
    }
