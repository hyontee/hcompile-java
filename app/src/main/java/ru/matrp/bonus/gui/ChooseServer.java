...
import ru.matrp.bonus.BuildConfig;
...
public class ChooseServer {
    ...
    public void show() {
        if (viewGroup == null) {
            ...
            viewGroup = (ViewGroup) ((LayoutInflater) NvEventQueueActivity.getInstance().getSystemService(Context.LAYOUT_INFLATER_SERVICE)).inflate(R.layout.loadingmenu, (ViewGroup) null);
