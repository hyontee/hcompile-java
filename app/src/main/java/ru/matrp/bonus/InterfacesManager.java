...
import ru.matrp.bonus.gui.ChooseServer;
import ru.matrp.bonus.gui.HudManager;
import ru.matrp.bonus.gui.Speedometer;
import ru.matrp.bonus.gui.chatedgar.ChatManager;
import ru.matrp.bonus.gui.dialogs.Dialog;
...
public class InterfacesManager {
    ...
    */
    ...
    public InterfacesManager(NvEventQueueActivity nvEventQueueActivity) {
        ...
        mChooseServer = new ChooseServer(nvEventQueueActivity, 6);
    }
