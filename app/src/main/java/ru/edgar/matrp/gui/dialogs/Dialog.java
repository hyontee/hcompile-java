package ru.edgar.matrp.gui.dialogs;
...
import ru.edgar.matrp.gui.util.CustomRecyclerView;
...
public class Dialog {
    ...
    private final FrameLayout mInputLayout;
    private final FrameLayout mLeftBtn;
    private final LinearLayout mListLayout;
    private final FrameLayout mMainLayout;
    private final ConstraintLayout mMsgBoxLayout;
    private final FrameLayout mRightBtn;
    private ArrayList<String> mRowsList;

    public Dialog(Activity activity) {
        this.mMainLayout = activity.findViewById(R.id.dialog);
        this.mCaption = (TextView) activity.findViewById(R.id.dialog_caption);
        this.mContent = (TextView) activity.findViewById(R.id.dialog_text);
        FrameLayout findViewById1 = activity.findViewById(R.id.button_positive);
        this.mLeftBtn = findViewById1;
        FrameLayout findViewById2 = activity.findViewById(R.id.button_negative);
        this.mRightBtn = findViewById2;
        this.mInputLayout = activity.findViewById(R.id.dialog_input_layout);
        this.mListLayout = activity.findViewById(R.id.dialog_list_layout);
        this.mMsgBoxLayout = (ConstraintLayout) activity.findViewById(R.id.dialog_text_layout);
        this.mInput = (CustomEditText) activity.findViewById(R.id.dialog_input);
        this.mCustomRecyclerView = (CustomRecyclerView) activity.findViewById(R.id.dialog_list_recycler);
        ...
        LinearLayout mHeadersLayout = activity.findViewById(R.id.dialog_tablist_row);
