        ...
        scall.enqueue(new Callback<List<Servers>>() {
            ...
            public void onResponse(Call<List<Servers>> call, Response<List<Servers>> response) {
                ...
                for (Servers server : servers) {
                    Lists.slist.add(new Servers(server.getColor(), server.getname(), server.getOnline(), server.getmaxOnline(), server.getRecommend(), server.getHost(), server.getPort(), server.getId()));
                }
            }
